  ...
  return (
    <div className="relative">
      <button
        type="button"
        onClick={() => setOpen((v) => !v)}
        className="inline-flex items-center gap-1.5 rounded-lg border border-espark-border bg-espark-surface px-3 py-1.5 text-xs font-semibold text-espark-ink/75 hover:bg-espark-soft"
      >
        <Truck className="h-3.5 w-3.5" /> Request delivery
      </button>

      {open && (
        <div className="absolute right-0 z-30 mt-2 w-72 rounded-xl border border-espark-border bg-espark-surface p-3 text-left shadow-lg">
          ...
          <input
            ...
            className="mb-2 w-full rounded-lg border border-espark-border px-2 py-1.5 text-xs"
          />
          <input
            value={phone}
          ...
          <Select
            ...
            className="mb-2 w-full rounded-lg border border-espark-border bg-espark-surface px-2 py-1.5 text-xs"
          >
          ...
          <div className="flex gap-2">
            <button
              ...
              onClick={() => void submit()}
              disabled={busy}
              className="flex-1 rounded-lg bg-espark-primary px-3 py-1.5 text-xs font-semibold text-white hover:bg-espark-primary/90 disabled:opacity-50"
            >
            ...
            <button
              ...
              className="rounded-lg border border-espark-border px-3 py-1.5 text-xs font-semibold text-espark-ink/60 hover:bg-espark-soft"
            >
              Cancel
            </button>
          </div>
