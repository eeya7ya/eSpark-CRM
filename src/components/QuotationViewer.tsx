    ...
    <div>
      ...
      <div className="no-print flex flex-wrap justify-end mb-3 gap-2">
        {salesLocked ? (
          <button
            ...
            className="rounded-md border border-espark-border px-4 py-2 text-sm font-semibold hover:bg-espark-soft"
          >
            Request changes
          </button>
        ) : (
      ...
      {requesting && (
        <div className="no-print fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-2xl border border-espark-border bg-espark-surface p-5 shadow-xl">
            ...
            <textarea
              ...
              className="mt-3 w-full rounded-lg border border-espark-border bg-espark-surface px-3 py-2 text-sm"
            />
            {requestError && (
            ...
            <div className="mt-3 flex justify-end gap-2">
              <button
                ...
                className="rounded-md border border-espark-border px-3 py-1.5 text-sm font-semibold hover:bg-espark-soft disabled:opacity-50"
              >
                Cancel
              </button>
              <button
